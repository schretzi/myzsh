# Generated by Powerlevel10k configuration wizard on 2020-09-08 at 19:12 CEST.
...
() {
  ...
  #   - P9K_KUBECONTEXT_CLOUD_CLUSTER=my-cluster-01
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLUSTER}:${P9K_KUBECONTEXT_NAMESPACE}'
